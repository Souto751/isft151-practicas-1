...
// heredada por elementos que pueden contener otros elementos listables dentro de sí. De esta forma un File hereda de IListable simplemente la función de list,
